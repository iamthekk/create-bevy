...
2. 询问目标仓库地址
    ...
    - 使用代理了解仓库信息, 提示词: `请加载 bevy 必备技能, 请认真分析 ./repo/{name} 的代码仓库, 仔细思考, 为其迁移至 bevy 插件提供具体可行的方案, 请输出研究报告, 迁移计划,任务分解, 保存到 docs/ 目录`
    - 更新 `CLAUDE.md`
3. 询问用户新插件需求
    - 使用代理将用户需求转化为 `PRD.md`, 提示词: `请加载 bevy 必备技能, 请认真分析 {用户需求}, 仔细思考, 为其开发bevy 插件提供具体可行的方案, 请输出研究报告, 计划,任务分解, 保存到 docs/ 目录`
    - 更新 `CLAUDE.md`
